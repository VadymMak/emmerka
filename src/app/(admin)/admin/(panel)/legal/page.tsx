...
export default function LegalPage() {
  ...
  if (loading) {
    return <div className={styles.loading}>Načítavam...</div>;
  }

  return (
    <div className={styles.page}>
      <div className={styles.header}>
        <h1 className={styles.title}>⚖️ Legal (DE)</h1>
        <p className={styles.note}>
          Tieto stránky sú viditeľné <strong>iba pre /de/ jazyk</strong> (nemeckí návštevníci).
          Impressum a Datenschutz sú povinné pre DE/AT/CH trh.
        </p>
      </div>
